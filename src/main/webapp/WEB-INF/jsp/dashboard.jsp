...
<main class="app-main">
    <%@include file="layout/entetecontent.jsp"%>
    <!--begin::App Content-->
                                ...
                                <small class="contacts-list-date float-end"> 2/28/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                    class="contacts-list-img"
                                                    src="${pageContext.request.contextPath}/img/user7-128x128.jpg"
                                                    alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                    class="contacts-list-img"
                                                    src="${pageContext.request.contextPath}/img/user5-128x128.jpg"
                                                    alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                                ...
                                <small class="contacts-list-date float-end"> 1/27/2023 </small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img
                                                    class="contacts-list-img"
                                                    src="${pageContext.request.contextPath}/img/user8-128x128.jpg"
                                                    alt="User Avatar"
                                            />
                                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
